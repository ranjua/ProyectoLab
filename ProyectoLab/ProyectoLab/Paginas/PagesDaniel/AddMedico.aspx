<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMedico.aspx.cs" Inherits="ProyectoLab.Paginas.PagesDaniel.AddMedico" %>
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <th>
                    <asp:Button ID="btnAgregarMedico" runat="server" Text="Agregar" OnClick="btnAgregarMedico_Click" /></th>
