...
namespace ProyectoLab.Paginas.PagesDaniel
{
    public partial class AddMedico : System.Web.UI.Page
    {
        ...
        protected void btnAgregarMedico_Click(object sender, EventArgs e)
        {
            ...
            String Comando = "INSERT Usuario (DPI,Nombre,Contrasenia,Fecha_Nacimiento,Telefono,Email,cod_Tipo) VALUES (" + txtDpi.Text + ",'" + txtNombre.Text + "','" + txtContrasenia.Text + "','" + txtNacimiento.Text + "','" + txtTelefono.Text + "','" + txtEmail.Text + "',2)";
